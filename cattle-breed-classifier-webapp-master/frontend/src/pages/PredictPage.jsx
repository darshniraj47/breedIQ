        ...
        <div className="page">
            ...
            <div className="predict-layout">
                ...
                <div>
                    ...
                    {/* History & Placeholder */}
                    {!result && !loading && (
                        <div className="glass-card predict-placeholder-card">
                            <div className="predict-scanner-visual">
                                <div className="predict-scanner-ring ring-1" />
                                <div className="predict-scanner-ring ring-2" />
                                <div className="predict-scanner-pulse" />
                                <span className="predict-scanner-icon">🤖</span>
                            </div>
                            <h3>AI Scanner Ready</h3>
                            <p style={{ color: 'var(--color-text-secondary)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
                                Upload or capture a cow or buffalo image on the left. Our Vision Transformer AI will instantly detect the breed and generate detailed insights.
                            </p>
                            <div className="placeholder-benefits-list">
                                {[
                                    { title: '⚡ Fast Processing', desc: 'Results in less than 1 second' },
                                    { title: '🎯 Detailed Metrics', desc: 'Confidence levels & top alternative breeds' },
                                    { title: '📋 Regional Insights', desc: 'Milk yield, lifespan, & regional origin statistics' }
                                ].map((b) => (
                            ...
                            {history.length > 0 && (
                                <div className="recent-history-section" style={{ marginTop: '2rem', borderTop: '1px solid rgba(15,23,42,0.08)', paddingTop: '1.5rem' }}>
                                    <h4 style={{ marginBottom: '1rem', color: 'var(--color-text-secondary)', fontSize: '0.9rem', fontWeight: 600 }}>Recent Predictions</h4>
                                    {history.slice(0, 3).map((entry) => (
                                        <div key={entry.id} className="topk-item">
                                            <span className="topk-name" style={{ fontWeight: 500 }}>{entry.predictedBreed}</span>
                                            <span className="topk-conf" style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>
